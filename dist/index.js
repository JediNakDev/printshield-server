...
var require_main = __commonJS((exports, module) => {
  ...
  var _instructions = function(result2, dotenvKey) {
    let uri;
    try {
...
var custom = function(check, _params = {}, fatal) {
  if (check)
...
var pgEnumWithSchema = function(enumName, values, schema) {
  ...
  const result = columns.reduce((result2, { path, field }, columnIndex) => {
    ...
    for (const [pathChunkIndex, pathChunk] of path.entries()) {
      if (pathChunkIndex < path.length - 1) {
        ...
        const value = node4[pathChunk] = rawValue === null ? null : decoder.mapFromDriverValue(rawValue);
...
var mapUpdateSet = function(table5, values) {
  const entries = Object.entries(values).filter(([, value]) => value !== undefined).map(([key, value]) => {
    if (is(value, SQL) || is(value, Column)) {
      return [key, value];
    } else {
      return [key, new Param(value, table5[Table.Symbol.Columns][key])];
    }
  });
  if (entries.length === 0) {
...
var getTableColumns = function(table5) {
  return table5[Table.Symbol.Columns];
};
var getTableLikeName = function(table5) {
  return is(table5, Subquery) ? table5._.alias : is(table5, View) ? table5[ViewBaseConfig].name : is(table5, SQL) ? undefined : table5[Table.Symbol.IsAlias] ? table5[Table.Symbol.Name] : table5[Table.Symbol.BaseName];
};
...
class PgBigInt53Builder extends PgIntColumnBaseBuilder {
  ...
  build(table5) {
    return new PgBigInt53(table5, this.config);
  }
}
...
class PgBigInt64Builder extends PgIntColumnBaseBuilder {
  ...
  build(table5) {
    return new PgBigInt64(table5, this.config);
  }
}
...
class PgBigSerial53Builder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgBigSerial53(table5, this.config);
  }
}
...
class PgBigSerial64Builder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgBigSerial64(table5, this.config);
  }
}
...
class PgBooleanBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgBoolean(table5, this.config);
  }
}
...
class PgCidrBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgCidr(table5, this.config);
  }
}
...
class PgCustomColumnBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgCustomColumn(table5, this.config);
  }
}
...
class PgDateBuilder extends PgDateColumnBaseBuilder {
  ...
  build(table5) {
    return new PgDate(table5, this.config);
  }
}
...
class PgDateStringBuilder extends PgDateColumnBaseBuilder {
  ...
  build(table5) {
    return new PgDateString(table5, this.config);
  }
}
...
class PgDoublePrecisionBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgDoublePrecision(table5, this.config);
  }
}
...
class PgInetBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgInet(table5, this.config);
  }
}
...
class PgIntegerBuilder extends PgIntColumnBaseBuilder {
  ...
  build(table5) {
    return new PgInteger(table5, this.config);
  }
}
...
class PgIntervalBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgInterval(table5, this.config);
  }
}
...
class PgJsonBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgJson(table5, this.config);
  }
}
...
class PgJsonbBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgJsonb(table5, this.config);
  }
}
...
class PgLineBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgLineTuple(table5, this.config);
  }
}
...
class PgLineABCBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgLineABC(table5, this.config);
  }
}
...
class PgMacaddrBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgMacaddr(table5, this.config);
  }
}
...
class PgMacaddr8Builder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgMacaddr8(table5, this.config);
  }
}
...
class PgNumericBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgNumeric(table5, this.config);
  }
}
...
class PgNumericNumberBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgNumericNumber(table5, this.config);
  }
}
...
class PgNumericBigIntBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgNumericBigInt(table5, this.config);
  }
}
...
class PgPointTupleBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgPointTuple(table5, this.config);
  }
}
...
class PgPointObjectBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgPointObject(table5, this.config);
  }
}
...
class PgGeometryBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgGeometry(table5, this.config);
  }
}
...
class PgGeometryObjectBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgGeometryObject(table5, this.config);
  }
}
...
class PgRealBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgReal(table5, this.config);
  }
}
...
class PgSerialBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgSerial(table5, this.config);
  }
}
...
class PgSmallIntBuilder extends PgIntColumnBaseBuilder {
  ...
  build(table5) {
    return new PgSmallInt(table5, this.config);
  }
}
...
class PgSmallSerialBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgSmallSerial(table5, this.config);
  }
}
...
class PgTextBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgText(table5, this.config);
  }
}
...
class PgTimeBuilder extends PgDateColumnBaseBuilder {
  ...
  build(table5) {
    return new PgTime(table5, this.config);
  }
}
...
class PgTimestampBuilder extends PgDateColumnBaseBuilder {
  ...
  build(table5) {
    return new PgTimestamp(table5, this.config);
  }
}
...
class PgTimestampStringBuilder extends PgDateColumnBaseBuilder {
  ...
  build(table5) {
    return new PgTimestampString(table5, this.config);
  }
}
...
class PgUUIDBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgUUID(table5, this.config);
  }
}
...
class PgBinaryVectorBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgBinaryVector(table5, this.config);
  }
}
...
class PgHalfVectorBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgHalfVector(table5, this.config);
  }
}
...
class PgSparseVectorBuilder extends PgColumnBuilder {
  ...
  build(table5) {
    return new PgSparseVector(table5, this.config);
  }
}
...
class PgDeleteBase extends QueryPromise {
  constructor(table9, session, dialect, withList) {
    ...
    this.config = { table: table9, withList };
  }
...
class CasingCache {
  ...
  getColumnCasing(column8) {
    if (!column8.keyAsName)
      return column8.name;
    const schema = column8.table[Table.Symbol.Schema] ?? "public";
    const tableName = column8.table[Table.Symbol.OriginalName];
    const key = `${schema}.${tableName}.${column8.name}`;
    if (!this.cache[key]) {
  ...
  cacheTable(table10) {
    const schema = table10[Table.Symbol.Schema] ?? "public";
    const tableName = table10[Table.Symbol.OriginalName];
    const tableKey = `${schema}.${tableName}`;
    if (!this.cachedTables[tableKey]) {
      for (const column8 of Object.values(table10[Table.Symbol.Columns])) {
...
class PgDialect {
  ...
  buildDeleteQuery({ table: table12, where, returning, withList }) {
    const withSql = this.buildWithCTE(withList);
    const returningSql = returning ? sql` returning ${this.buildSelection(returning, { isSingleTable: true })}` : undefined;
    const whereSql = where ? sql` where ${where}` : undefined;
    return sql`${withSql}delete from ${table12}${whereSql}${returningSql}`;
  }
  buildUpdateSet(table12, set) {
    const tableColumns = table12[Table.Symbol.Columns];
  ...
  buildUpdateQuery({ table: table12, set, where, returning, withList, from, joins }) {
    const withSql = this.buildWithCTE(withList);
    const tableName = table12[PgTable.Symbol.Name];
    const tableSchema = table12[PgTable.Symbol.Schema];
    const origTableName = table12[PgTable.Symbol.OriginalName];
    const alias3 = tableName === origTableName ? undefined : tableName;
    const tableSql = sql`${tableSchema ? sql`${sql.identifier(tableSchema)}.` : undefined}${sql.identifier(origTableName)}${alias3 && sql` ${sql.identifier(alias3)}`}`;
    const setSql = this.buildUpdateSet(table12, set);
  ...
  buildJoins(joins) {
    ...
    for (const [index, joinMeta] of joins.entries()) {
      ...
      const table12 = joinMeta.table;
      const lateralSql = joinMeta.lateral ? sql` lateral` : undefined;
      if (is(table12, PgTable)) {
        const tableName = table12[PgTable.Symbol.Name];
        const tableSchema = table12[PgTable.Symbol.Schema];
        const origTableName = table12[PgTable.Symbol.OriginalName];
        const alias3 = tableName === origTableName ? undefined : joinMeta.alias;
        joinsArray.push(sql`${sql.raw(joinMeta.joinType)} join${lateralSql} ${tableSchema ? sql`${sql.identifier(tableSchema)}.` : undefined}${sql.identifier(origTableName)}${alias3 && sql` ${sql.identifier(alias3)}`} on ${joinMeta.on}`);
      } else if (is(table12, View)) {
        const viewName = table12[ViewBaseConfig].name;
        const viewSchema = table12[ViewBaseConfig].schema;
        const origViewName = table12[ViewBaseConfig].originalName;
        const alias3 = viewName === origViewName ? undefined : joinMeta.alias;
        joinsArray.push(sql`${sql.raw(joinMeta.joinType)} join${lateralSql} ${viewSchema ? sql`${sql.identifier(viewSchema)}.` : undefined}${sql.identifier(origViewName)}${alias3 && sql` ${sql.identifier(alias3)}`} on ${joinMeta.on}`);
      } else {
        joinsArray.push(sql`${sql.raw(joinMeta.joinType)} join${lateralSql} ${table12} on ${joinMeta.on}`);
      }
  ...
  buildFromTable(table12) {
    if (is(table12, Table) && table12[Table.Symbol.IsAlias]) {
      let fullName = sql`${sql.identifier(table12[Table.Symbol.OriginalName])}`;
      if (table12[Table.Symbol.Schema]) {
        fullName = sql`${sql.identifier(table12[Table.Symbol.Schema])}.${fullName}`;
      }
      return sql`${fullName} ${sql.identifier(table12[Table.Symbol.Name])}`;
    }
    return table12;
  }
  buildSelectQuery({
    ...
    for (const f of fieldsList) {
      if (is(f.field, Column) && getTableName(f.field.table) !== (is(table12, Subquery) ? table12._.alias : is(table12, PgViewBase) ? table12[ViewBaseConfig].name : is(table12, SQL) ? undefined : getTableName(table12)) && !((table22) => joins?.some(({ alias: alias3 }) => alias3 === (table22[Table.Symbol.IsAlias] ? getTableName(table22) : table22[Table.Symbol.BaseName])))(f.field.table)) {
    ...
    const tableSql = this.buildFromTable(table12);
    const joinsSql = this.buildJoins(joins);
    const whereSql = where ? sql` where ${where}` : undefined;
  ...
  buildInsertQuery({ table: table12, values: valuesOrSelect, onConflict, returning, withList, select, overridingSystemValue_ }) {
    const valuesSqlList = [];
    const columns2 = table12[Table.Symbol.Columns];
    const colEntries = Object.entries(columns2).filter(([_, col]) => !col.shouldDisableInsert());
    const insertOrder = colEntries.map(([, column9]) => sql.identifier(this.casing.getColumnCasing(column9)));
    if (select) {
    ...
    return sql`${withSql}insert into ${table12} ${insertOrder} ${overridingSql}${valuesSql}${onConflictSql}${returningSql}`;
  }
    ...
    if (nestedQueryRelation) {
      ...
      if (needsSubquery) {
        result = this.buildSelectQuery({
          table: aliasedTable(table12, tableAlias),
          fields: {},
          fieldsFlat: [{
            path: [],
            field: sql.raw("*")
        ...
        result = aliasedTable(table12, tableAlias);
      }
      result = this.buildSelectQuery({
...
class PgSelectQueryBuilderBase extends TypedQueryBuilder {
  ...
  session;
  dialect;
  constructor({ table: table13, fields, isPartialSelect, session, dialect, withList, distinct }) {
    super();
    this.config = {
      withList,
      table: table13,
    ...
    this.tableName = getTableLikeName(table13);
    this.joinsNotNullableMap = typeof this.tableName === "string" ? { [this.tableName]: true } : {};
  }
  createJoin(joinType) {
    return (table13, on) => {
      const baseTableName = this.tableName;
      const tableName = getTableLikeName(table13);
      ...
      if (!this.isPartialSelect) {
        ...
        if (typeof tableName === "string" && !is(table13, SQL)) {
          const selection = is(table13, Subquery) ? table13._.selectedFields : is(table13, View) ? table13[ViewBaseConfig].selectedFields : table13[Table.Symbol.Columns];
      ...
      this.config.joins.push({ on, table: table13, joinType, alias: tableName });
...
class PgInsertBuilder {
  constructor(table14, session, dialect2, withList, overridingSystemValue_) {
    this.table = table14;
    this.session = session;
...
class PgInsertBase extends QueryPromise {
  constructor(table14, values, session, dialect2, withList, select2, overridingSystemValue_) {
    super();
    this.session = session;
    this.dialect = dialect2;
    this.config = { table: table14, values, withList, select: select2, overridingSystemValue_ };
  }
...
class PgUpdateBase extends QueryPromise {
  constructor(table16, set, session, dialect2, withList) {
    ...
    this.session = session;
    this.dialect = dialect2;
    this.config = { set, table: table16, withList, joins: [] };
    this.tableName = getTableLikeName(table16);
    this.joinsNotNullableMap = typeof this.tableName === "string" ? { [this.tableName]: true } : {};
  }
  ...
  getTableLikeFields(table16) {
    if (is(table16, PgTable)) {
      return table16[Table.Symbol.Columns];
    } else if (is(table16, Subquery)) {
      return table16._.selectedFields;
    }
    return table16[ViewBaseConfig].selectedFields;
  }
  createJoin(joinType) {
    return (table16, on) => {
      const tableName = getTableLikeName(table16);
      if (typeof tableName === "string" && this.config.joins.some((join) => join.alias === tableName)) {
        throw new Error(`Alias "${tableName}" is already used in this query`);
      }
      if (typeof on === "function") {
      ...
      this.config.joins.push({ on, table: table16, joinType, alias: tableName });
      if (typeof tableName === "string") {
        switch (joinType) {
          case "left": {
            this.joinsNotNullableMap[tableName] = false;
...
class PgRaw extends QueryPromise {
  constructor(execute, sql17, query, mapBatchResult) {
    super();
...
// src/db/schema.ts
var errorType = pgEnum("error_type", ["camera", "filament"]);
var errorTable = pgTable("error_table", {
...
var Connection = function(options, queues = {}, { onopen = noop, onend = noop, onclose = noop } = {}) {
  ...
  function ErrorResponse(x) {
    ...
    query4 && query4.retried ? errored(query4.retried) : query4 && query4.prepared && retryRoutines.has(error2.routine) ? retry(query4, error2) : errored(error2);
  }
...
var parse = function(x, state, parsers2, handle, transform) {
  const char3 = (acc, [k, v]) => (acc[k.charCodeAt(0)] = v, acc);
  Object.entries({
    R: (x2) => {
      let i = 1;
...
function Subscribe(postgres2, options) {
  ...
  const sql19 = subscribe.sql = postgres2({
    ...options,
    ...
    onclose: async function() {
      ...
      connected(await init(sql19, slot, options.publications));
      subscribers.forEach((event) => event.forEach(({ onsubscribe }) => onsubscribe()));
    },
    no_subscribe: true
  });
  const { end, close } = sql19;
  sql19.end = async () => {
    ended = true;
  ...
  async function subscribe(event, fn, onsubscribe = noop2, onerror = noop2) {
    ...
    if (!connection2)
      connection2 = init(sql19, slot, options.publications);
    ...
    return connection2.then((x) => {
      ...
      return { unsubscribe, state, sql: sql19 };
    });
  }
  ...
  async function init(sql20, slot2, publications) {
    if (!publications)
      throw new Error("Missing publication names");
    const xs = await sql20.unsafe(`CREATE_REPLICATION_SLOT ${slot2} TEMPORARY LOGICAL pgoutput NOEXPORT_SNAPSHOT`);
    const [x] = xs;
    const stream2 = await sql20.unsafe(`START_REPLICATION SLOT ${slot2} LOGICAL ${x.consistent_point} (proto_version '1', publication_names '${publications}')`).writable();
    const state2 = {
      lsn: Buffer.concat(x.consistent_point.split("/").map((x2) => Buffer.from(("00000000" + x2).slice(-8), "hex")))
    };
    stream2.on("data", data);
    stream2.on("error", error);
    stream2.on("close", sql20.close);
    ...
    function data(x2) {
      if (x2[0] === 119) {
        parse(x2.subarray(25), state2, sql20.options.parsers, handle, options.transform);
...
function largeObject(sql19, oid, mode = 131072 | 262144) {
  return new Promise(async (resolve, reject) => {
    await sql19.begin(async (sql20) => {
      let finish;
      !oid && ([{ oid }] = await sql20`select lo_creat(-1) as oid`);
      const [{ fd }] = await sql20`select lo_open(${oid}, ${mode}) as fd`;
      const lo = {
        writable,
        readable,
        close: () => sql20`select lo_close(${fd})`.then(finish),
        tell: () => sql20`select lo_tell64(${fd})`,
        read: (x) => sql20`select loread(${fd}, ${x}) as data`,
        write: (x) => sql20`select lowrite(${fd}, ${x})`,
        truncate: (x) => sql20`select lo_truncate64(${fd}, ${x})`,
        seek: (x, whence = 0) => sql20`select lo_lseek64(${fd}, ${x}, ${whence})`,
        size: () => sql20`
          select
...
var Postgres = function(a, b2) {
  ...
  const sql19 = Sql(handler);
  Object.assign(sql19, {
    get parameters() {
      return options.parameters;
    },
    largeObject: largeObject.bind(null, sql19),
  ...
  async function listen(name, fn, onlisten) {
    ...
    const sql20 = listen.sql || (listen.sql = Postgres({
      ...options,
      max: 1,
      idle_timeout: null,
      max_lifetime: null,
    ...
    channels[name] = { result: sql20`listen ${sql20.unsafe('"' + name.replace(/"/g, '""') + '"')}`, listeners: [listener] };
    ...
    async function unlisten() {
      ...
      return sql20`unlisten ${sql20.unsafe('"' + name.replace(/"/g, '""') + '"')}`;
    }
  }
  async function notify(channel, payload) {
    return await sql19`select pg_notify(${channel}, ${"" + payload})`;
  }
  ...
  async function begin(options2, fn) {
    ...
    try {
      await sql19.unsafe("begin " + options2.replace(/[^a-z ]/ig, ""), [], { onexecute }).execute();
    ...
    async function scope(c, fn2, name) {
      const sql20 = Sql(handler2);
      sql20.savepoint = savepoint;
      sql20.prepare = (x) => prepare = x.replace(/[^a-z0-9$-_. ]/gi);
      let uncaughtError, result2;
      name && await sql20`savepoint ${sql20(name)}`;
      try {
        ...
        await (name ? sql20`rollback to ${sql20(name)}` : sql20`rollback`);
        throw e instanceof PostgresError && e.code === "25P02" && uncaughtError || e;
      }
      if (!name) {
        prepare ? await sql20`prepare transaction '${sql20.unsafe(prepare)}'` : await sql20`commit`;
      }
      return result2;
      function savepoint(name2, fn3) {
        if (name2 && Array.isArray(name2.raw))
          return savepoint((sql21) => sql21.apply(sql21, arguments));
...
var parseOptions = function(a, b2) {
  if (a && a.shared)
    return a;
  const env = process.env, o = (!a || typeof a === "string" ? b2 : a) || {}, { url: url6, multihost } = parseUrl(a), query5 = [...url6.searchParams].reduce((a2, [b3, c]) => (a2[b3] = c, a2), {}), host = o.hostname || o.host || multihost || url6.hostname || env.PGHOST || "localhost", port = o.port || url6.port || env.PGPORT || 5432, user = o.user || o.username || url6.username || env.PGUSERNAME || env.PGUSER || osUsername();
  ...
  return {
    ...
    database: o.database || o.db || (url6.pathname || "").slice(1) || env.PGDATABASE || user,
    user,
    pass: o.pass || o.password || url6.password || env.PGPASSWORD || "",
    ...
    types: o.types || {},
    target_session_attrs: tsa(o, url6, env),
    onnotice: o.onnotice,
    onnotify: o.onnotify,
    onclose: o.onclose,
...
var tsa = function(o, url6, env) {
  const x = o.target_session_attrs || url6.searchParams.get("target_session_attrs") || env.PGTARGETSESSIONATTRS;
...
var parseUrl = function(url6) {
  if (!url6 || typeof url6 !== "string")
    return { url: { searchParams: new Map } };
  let host = url6;
  host = host.slice(host.indexOf("://") + 3).split(/[?/]/)[0];
  host = decodeURIComponent(host.slice(host.indexOf("@") + 1));
  const urlObj = new URL(url6.replace(host, host.split(",")[0]));
  return {
    url: {
...
class PostgresJsSession extends PgSession {
  ...
  logger;
  prepareQuery(query5, fields, name, isResponseInArrayMode, customResultMapper) {
    return new PostgresJsPreparedQuery(this.client, query5.sql, query5.params, this.logger, fields, isResponseInArrayMode, customResultMapper);
  }
  query(query5, params) {
...
var construct = function(client, config = {}) {
  ...
  const dialect3 = new PgDialect({ casing: config.casing });
  let logger3;
  ...
  const db3 = new PostgresJsDatabase(dialect3, session3, schema);
  db3.$client = client;
  return db3;
};
var drizzle = function(...params) {
  ...
  if (isConfig(params[0])) {
    const { connection: connection3, client, ...drizzleConfig } = params[0];
    if (client)
      return construct(client, drizzleConfig);
    if (typeof connection3 === "object" && connection3.url !== undefined) {
      const { url: url6, ...config } = connection3;
      const instance2 = src_default(url6, config);
      return construct(instance2, drizzleConfig);
    }
    const instance = src_default(connection3);
...
var conn = globalForDb.conn ?? src_default(process.env.DATABASE_URL ?? "");
if (true)
  globalForDb.conn = conn;
var db3 = drizzle(conn, { schema: exports_schema });
...
app.post("/camera", async (c) => {
  ...
  const { success, data, error } = bodySchema.safeParse(body2);
  if (!success) {
    return c.json({
      success,
  ...
  const text3 = `${data.printerId} is having a printing error (From Printshield Camera)`;
  const url6 = `https://api.telegram.org/bot7699799142:AAFOwjQTbBUMvJbLe5MC5iYXEdltdqgl0Gc/sendMessage?chat_id=-1002584756620&text=${text3}`;
  await fetch(url6);
  await db3.insert(errorTable).values({
...
app.post("/filament", async (c) => {
  ...
  const text3 = `${data.printerId} has low filament (From Printshield Filament Sensor)`;
  const url6 = `https://api.telegram.org/bot7699799142:AAFOwjQTbBUMvJbLe5MC5iYXEdltdqgl0Gc/sendMessage?chat_id=-1002584756620&text=${text3}`;
  await fetch(url6);
  await db3.insert(errorTable).values({
    printerId: data.printerId,
